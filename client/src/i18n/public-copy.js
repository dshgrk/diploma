...
export const CHECKOUT_COPY = {
  uk: {
    ...
    confirmDemoPayment: "Перейти до замовлення",
    ...
    orderReservedCopy: "Резерв створено. Після підтвердження оплати замовлення з'явиться в історії.",
    ...
    reservedAfterPrepayment: "Резерв після передплати",
    ...
    stepPaymentConfirmed: "Передплату підтверджено",
    total: "Разом"
  },
  en: {
    ...
    orderReservedCopy: "Reservation created. After payment confirmation the order will appear in your history.",
    ...
    reservedAfterPrepayment: "Reserved after prepayment",
