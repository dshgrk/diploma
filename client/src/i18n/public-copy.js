...
export const CHECKOUT_COPY = {
  uk: {
    ...
    checkoutIntro: "Зарезервуйте обрані вироби, залиште деталі доставки й перейдіть до підтвердження оплати.",
    confirmDemoPayment: "Перейти до оплати",
    ...
    orderReservedCopy: "Резерв створено. Перейдіть до оплати, щоб підтвердити замовлення.",
    orderReservedToast: "Замовлення зарезервовано. Продовжіть до оплати.",
  ...
  en: {
    ...
    checkoutIntro: "Reserve selected pieces, leave delivery details, and continue to payment confirmation.",
    confirmDemoPayment: "Continue to payment",
    confirmDetails: "Confirm atelier details",
    confirmDetailsText: "We will use these details for delivery and order status updates.",
    ...
    orderReservedCopy: "Reservation created. Continue to payment to confirm your order.",
    orderReservedToast: "Your order is reserved. Continue to payment.",
...
export const PAYMENT_COPY = {
  uk: {
    amountToPay: "До оплати",
    cardHolder: "Ім'я власника картки",
    ...
    payNow: "Сплатити",
    payingNow: "Підтверджуємо оплату...",
    paymentDidNotLoad: "Сторінка оплати не завантажилася",
    paymentHint: "Перевірте суму й підтвердьте оплату, щоб передати замовлення в роботу ательє.",
    paymentIntro: "Цей крок завершує оформлення: після підтвердження оплати ательє починає роботу.",
    paymentSuccess: "Оплату підтверджено",
    paymentSuccessCopy: "Замовлення переведено в обробку ательє.",
    paymentSuccessToast: "Оплату підтверджено.",
  ...
  en: {
    ...
    payNow: "Pay now",
    payingNow: "Confirming payment...",
    paymentDidNotLoad: "Payment page did not load",
    paymentHint: "Review the amount and confirm payment to move the order into atelier processing.",
    paymentIntro: "This step completes checkout: after payment confirmation, the atelier starts work.",
    paymentSuccess: "Payment confirmed",
    paymentSuccessCopy: "The order has moved into atelier processing.",
    paymentSuccessToast: "Payment confirmed.",
