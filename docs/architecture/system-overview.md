...
- Один backend-сервис.
- Одна основная база данных MySQL.
...
| `admin-catalog` | CRUD товаров, материалов, изображений и опций | Нет, Phase 2 |
...
- выступает единственным постоянным хранилищем MVP.
...
- редактирование товаров и материалов через UI;
